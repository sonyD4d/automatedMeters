      ...
      <div class="dup-body-wrap">
         ...
         <section class="sample-text-area">
            <div class="container">
               ...
               <div align=right>
                  <? if(isset($_POST['show'])){ ?>
                  <form method="post" class="subscription relative" action="./history.php" style="width:250px;" align=right>
                     <input type="text" name="year" placeholder="<? echo $year; ?>" required>
                     <input type="hidden" value="<?php echo $_POST['p_type']; ?>" name="p_type">
                     <input type="hidden" value="<?php echo $_POST['p_unit']; ?>" name="p_unit">
                     <input type="hidden" value="<?php echo $_POST['p_name']; ?>" name="p_name">
                     <input type="hidden" value="<?php echo $_POST['sub_id']; ?>" name="sub_id">
               ...
               <div class="container" align=center>
                  <div class="row" align=center>
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="./history.php" class="genric-btn primary-border"> < BACK</a>
                     </div>
                     <div class="col-md-1">
                        <div class="v2" ></div>
                     </div>
                     <div class="col-md-8">
                        ...
                        <div class="row" align=center>
                           <?
                              $sub_id=$_POST['sub_id'];
                              $q="SELECT avg(`cost`) as \"avg_cost_sub\",avg(`cons`) as \"avg_cons_sub\",max(`cost`) as \"max_cost_sub\",min(`cost`) as \"min_cost_sub\",max(`cons`) as \"max_cons_sub\",min(`cons`) as \"min_cons_sub\" FROM `meter_billing` WHERE `sub_id`='$sub_id' AND `date`>'$year-01-01' AND `date`<'$year-12-31'";
                              if($innerRes=mysqli_query($conn,$q)){
                                       $innerR=mysqli_fetch_object($innerRes);
                                         ?>
                           ...
                           <div class="col-md-4">
                              <p>Average</p>
                              <h3><?echo round($innerR->avg_cost_sub,2);?></h3>
                              <hr>
                              <h1 class="about-title" align=center><b>INR</b></h1>
                              <p>COST</p>
                              <hr>
                              <h3>
                                 <p style="color:green;display:inline;"><? echo round($innerR->min_cost_sub,2);?></p>
                                 -
                                 <p style="color:red;display:inline;"><? echo round($innerR->max_cost_sub,2);?></p>
                              </h3>
                              <p>Range</p>
                           </div>
                           <div class="col-md-4">
                              <p>Average</p>
                              <h3><?echo round($innerR->avg_cons_sub,2);?></h3>
                              <hr>
                              <h1 class="about-title" align=center><b><? echo $_POST['p_unit'];?></b></h1>
                              <p>CONSUPTION</p>
                              <hr>
                              <h3>
                                 <p style="color:green;display:inline;"><? echo round($innerR->min_cons_sub,2);?></p>
                                 -
                                 <p style="color:red;display:inline;"><? echo round($innerR->max_cons_sub,2);?></p>
                              </h3>
                              <p>Range</p>
                           </div>
                           <?
                        ...
                        <hr>
                        <?php dC(json_encode($St),$_POST['p_unit']);?>
                        <? }
